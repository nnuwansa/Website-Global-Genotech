...
const CASES = [
  {
    ...
    desc: "Delivered a multi-branch POS system covering checkout, inventory sync and daily sales reporting across all locations.",
    metric: "Real-time stock sync",
    color: "bg-[color:var(--color-navy)]",
  },
  {
    tag: "MIS",
    title: "Leave management system",
    desc: "Built an end-to-end leave management system with approval workflows, balance tracking and manager dashboards for a multi-department organization.",
    metric: "Paperless approvals",
    color: "bg-[color:var(--color-blue-600)]",
  },
  
  {
    tag: "E-commerce",
    title: "Online storefront & checkout",
    desc: "Built a full e-commerce platform with product catalog, cart, and secure checkout integrated with local payment gateways.",
    metric: "Faster checkout flow",
    color: "bg-[color:var(--color-yellow-600)]",
  },
  {
    tag: "MIS",
    title: "Fleet & vehicle management system",
    desc: "Designed a vehicle management system tracking maintenance schedules, fuel logs and driver assignments in one dashboard.",
    metric: "Centralized fleet data",
    color: "bg-[color:var(--color-blue-700)]",
  },
  {
    tag: "MIS",
    title: "Arbitration case management system",
    desc: "Built a case management system for tracking arbitration cases, hearing schedules, documents and status updates end to end.",
    metric: "Structured case tracking",
    color: "bg-[color:var(--color-navy)]",
  },
  {
    tag: "MIS",
    title: "Internal mail & correspondence system",
    desc: "Developed an internal mail management system for logging, routing and tracking official correspondence across departments.",

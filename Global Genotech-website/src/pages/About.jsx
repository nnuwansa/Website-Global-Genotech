...
const VALUES = [
  ...
  },
  {
    icon: HeartHandshake,
    title: "Radical transparency",
    desc: "You get access to our process, our progress, and our honest opinion — even when it's inconvenient.",
  },
  {
    icon: Gauge,
    title: "Bias for speed",
...
export default function About() {
  return (
    <>
      <PageHeader
        eyebrow="About Us"
        title="A software team built to solve real business problems"
        description="We build custom software, POS and MIS solutions for businesses that need systems that actually work — not just systems that look good in a demo."
      />
      ...
      <section className="px-6 pb-24 lg:px-10">
        <div className="mx-auto grid max-w-6xl gap-14 lg:grid-cols-2 lg:gap-20">
          <div>
            <Eyebrow>Our story</Eyebrow>
            <h2 className="mt-4 font-display text-3xl font-bold leading-tight text-[color:var(--color-navy)] sm:text-4xl">
              From simple requests to complete business systems
            </h2>
            <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-[color:var(--color-slate-500)]">
              <p>
                We started by helping local businesses digitize their daily
                operations — a POS system here, an inventory tracker there.
                Every project taught us something the last one didn&apos;t.
              </p>
              <p>
                That hands-on experience shaped how we work today: senior
                engineers, direct communication, and software we&apos;d be
                comfortable running our own business on.
              </p>
              <p>
                Now we build everything from custom MIS platforms to
                multi-branch POS networks, helping businesses replace manual
                processes with systems that scale with them.
              </p>
            </div>
          </div>
      ...
      <section className="bg-[color:var(--color-cloud)] px-6 py-24 lg:px-10">
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto max-w-2xl text-center">
            <Eyebrow>What clients say</Eyebrow>
            <h2 className="mt-4 font-display text-3xl font-bold leading-tight text-[color:var(--color-navy)] sm:text-4xl">
              Our work speaks through what we deliver
            </h2>
          </div>
          <div className="mt-14">
            <Testimonials />

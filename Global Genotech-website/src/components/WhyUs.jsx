...
const POINTS = [
  "Senior engineers who write the code, not just manage it.",
  "You talk directly to the person building your product — no middlemen.",
  "Clear timelines and honest updates, even when things slip.",
  "Simple, upfront pricing with no hidden costs.",
];
  ...
  return (
    <div className="grid items-center gap-14 lg:grid-cols-2 lg:gap-20">
      <div>
        ...
        <p className="mt-4 text-[16px] leading-relaxed text-[color:var(--color-slate-500)]">
          We're not a big agency shuffling your project between teams. You
          work directly with the people building your software, from the
          first call to launch day.
        </p>
